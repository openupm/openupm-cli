...
import { makeDomainName } from "./domain-name";
import { makeSemanticVersion } from "./semantic-version";
import { addScope, makeScopedRegistry } from "./scoped-registry";
import { makeRegistryUrl } from "./registry-url";
