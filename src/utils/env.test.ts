import { TokenAuth, UPMConfig } from "../domain/upm-config";
import { NpmAuth } from "another-npm-registry-client";
import { Env, parseEnv } from "./env";
import log from "../cli/logger";
import { tryLoadProjectVersion } from "../io/project-version-io";
import { Err, Ok } from "ts-results-es";
import { tryGetUpmConfigDir } from "../io/upm-config-io";
import fs from "fs";
